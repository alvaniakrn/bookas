...
<body>
    <div class="container-fluid">
        ...
        <div class="section-doctor">
            <div class="container-navbar">
                <h1>Pencarian Dokter Lanjut</h1>
                <form method="POST" action="/cari-dokter">
                    @csrf
                    <div class="form-group row">
                      <label for="idDokter" class="col-sm-2 col-form-label">ID Dokter</label>
                      <div class="col-sm-10">
                        <input type="text" name="idDokter" class="form-control" id="idDokter" placeholder="ID Dokter">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="spesialis" class="form-control" id="spesialis" placeholder="Spesialis">
                        </div>
                    </div>
